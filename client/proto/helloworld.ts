...
export const GreeterService = {
  ...
  sayHelloBidirectionalStreaming: {
    path: "/helloworld.Greeter/SayHelloBidirectionalStreaming",
    requestStream: true,
    responseStream: true,
    requestSerialize: (value: HelloRequest) => Buffer.from(HelloRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => HelloRequest.decode(value),
...
export interface GreeterServer extends UntypedServiceImplementation {
  ...
  sayHelloStreamRequest: handleClientStreamingCall<HelloRequest, HelloReply>;
  sayHelloBidirectionalStreaming: handleBidiStreamingCall<HelloRequest, HelloReply>;
}
...
export interface GreeterClient extends Client {
  ...
  sayHelloBidirectionalStreaming(): ClientDuplexStream<HelloRequest, HelloReply>;
  sayHelloBidirectionalStreaming(options: Partial<CallOptions>): ClientDuplexStream<HelloRequest, HelloReply>;
  sayHelloBidirectionalStreaming(
    metadata: Metadata,
    options?: Partial<CallOptions>,
  ): ClientDuplexStream<HelloRequest, HelloReply>;
}
